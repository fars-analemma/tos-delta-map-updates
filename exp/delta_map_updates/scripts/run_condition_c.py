#!/usr/bin/env python3
# Entry point for running Condition C (delta-map updates) experiment.
# Usage: python -m delta_map_updates.scripts.run_condition_c [--num N] [--start S]
...
from delta_map_updates.runners.condition_c_runner import run_condition_c_all


def main():
    parser = argparse.ArgumentParser(description="Run Condition C cognitive map probing")
